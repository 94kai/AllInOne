...
- 统一音乐入口，通过“小爱播放 / 音乐下载”切换：播放侧采用响应式家庭音乐控制台，管理两台音箱及本地曲库，支持实时队列、持久播放列表、搜索后单首/批量加入、我喜欢、单曲或列表按指定轮数播放、0–100 音量控制和向指定音箱发送文字播报；下载侧支持聚合搜索、异步下载、在线试听、确认删除、批量移动和音频元信息刮削
